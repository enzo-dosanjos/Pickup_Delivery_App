...
class MapTest {
    ...
    void checkLoadMapUpdatesIntersectionsAndAdjacencyList() {
        ...
        assertEquals(2, map.getIntersections().size(), "Precondition: Map should have 2 intersections");
        assertEquals(1, map.getAdjencyList().size(), "Precondition: Map should have 1 adjacency entry");

        map.loadMap("src/test/resources/empty_test_map.xml");

        assertTrue(map.getIntersections().isEmpty(), "Intersections should be updated");
        assertTrue(map.getAdjencyList().isEmpty(), "Adjacency list should be updated");
    }
